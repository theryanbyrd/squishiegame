  ...
  return (
    <div className="page">
      ...
      <div className="summary-card howto">
        ...
        <p>⏱ <b>Timed Mode</b>: race a 60-second clock to pass as many openings as you can! Treats are rarer but add time instead of points (+2s in your path, +4s or +6s up high or down low, +10s golden). Watch out — crashing still ends your run!</p>
